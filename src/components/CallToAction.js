    ...
    <section id="cta" className="py-20 bg-blue-600 text-white text-center">
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
          <span className="bg-white text-blue-600 px-8 py-4 rounded-md font-medium hover:bg-gray-100 transition cursor-pointer">
            Book a Technical Demo
          </span>
          <span className="bg-blue-700 text-white px-8 py-4 rounded-md font-medium hover:bg-blue-800 transition border border-blue-500 cursor-pointer">
            Get Early Access
          </span>
        </div>
      </div>
